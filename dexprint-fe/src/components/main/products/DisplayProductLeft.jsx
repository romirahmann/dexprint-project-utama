...
export function DisplayProductLeft() {
  const promoImage =
  ...
  return (
    <div className="w-full p-4 md:p-8 lg:p-12">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        {/* LEFT BANNER */}
        <div className="bg-white rounded-2xl overflow-hidden shadow-md h-[200px] md:h-[260px] lg:h-full">
